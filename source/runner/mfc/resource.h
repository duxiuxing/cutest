...
#define IDS_ERROR_CLOSE_TEST_DIALOG     7
#define IDS_ERROR_FINISH_TEST_CASE      8
#define IDS_PROGRESS_NONE               9
#define IDD_TEST_RUNNER                 102
#define IDD_TEST_HIERARCHY              103
#define IDR_ACCELERATOR_TEST_RUNNER     129
#define IDR_MAINFRAME                   130
#define IDB_ERROR_TYPE                  131
#define IDB_TEST_TYPE                   132
