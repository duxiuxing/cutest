...
MockTestListener::MockTestListener( std::string name )
    ...
    , m_expectedStartTestRun( NULL )
    , m_expectedStartTestRun2( NULL )
    ...
    , m_expectedEndTestRun( NULL )
    , m_expectedEndTestRun2( NULL)
    , m_endTestRunCall( 0 )
