...
MainTestDecorator *
MainTestDecorator::createInstance( Test *test )
{
...
void
MainTestDecoratorImpl::destroy()
{
  delete this;
}

void
MainTestDecoratorImpl::addListener( TestListener *listener )
{
  _testResult.addListener( listener );
}

void
MainTestDecoratorImpl::start()
{
...
void *
MainTestDecoratorImpl::threadFunction( void *pThis )
{
...
void
MainTestDecoratorImpl::runOnWorkerThread()
{
  if ( STATE_RUNING == _state )
  {
...
MainTestDecoratorImpl::testResultCollector()
{
  return &_resultCollector;
}

void
MainTestDecoratorImpl::startTest( Test *test )
{
  _testRuning = test;
}

void
MainTestDecoratorImpl::endTest( Test *test )
{
  _testRuning = NULL;
}

void
MainTestDecoratorImpl::addFailure( bool is_error, Exception *exception )
{
  if ( is_error )
  {
