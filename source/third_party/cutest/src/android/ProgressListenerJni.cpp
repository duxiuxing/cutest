...
void TestProgressListenerJni::onFailureAdd(unsigned int index, const TestFailure& failure) {
...
void TestProgressListenerJni::onTestEnd(
    Test* test,
...
void TestProgressListenerJni::setJavaEntity(JNIEnv* env, jobject value) {
    deleteJavaRef();
...
void TestProgressListenerJni::deleteJavaRef() {
    if (_javaEntity) {
